...
*******************************************************************************/
	...
	public static String problemRep;
...
*******************************************************************************/
	...
	public Parameters(String parmfilename) throws java.io.IOException{
		...
		problemRep = parmInput.readLine().substring(30);
		...
		slots = Integer.parseInt(parmInput.readLine().substring(30).trim());
		monitors = Integer.parseInt(parmInput.readLine().substring(30).trim());
...
*******************************************************************************/
	...
	public static void outputParameters(FileWriter output) throws java.io.IOException{
		...
		output.write("Representation               :  " + problemRep + "\n");
		...
		output.write("Number of Slots              :  " + slots + "\n");
		output.write("Number of Monitors           :  " + monitors + "\n");
